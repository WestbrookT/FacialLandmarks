...
for i in range(1, 20):
    ...
    images, answers = conv.load_dataset(scale=.125, max_id=num+5, min_id=num)
    ...
    print('\n' * 5, 'Epoch:', i, '\n' * 5)
    model.fit(images, answers, nb_epoch=150, batch_size=32)
